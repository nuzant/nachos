...
public class KThread {
	...
	begin();
    target.run();
    // wake up the thread that calls join after this thread finishes
    joinSemaphore.V();
	finish();
    }
    ...
    // sleep the thread that calls join(), until this thread finishes.
    joinSemaphore.P();
    ...
    /**
     * Semaphore that implements join()
     */
